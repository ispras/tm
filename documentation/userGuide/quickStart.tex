...
\subsection{Read the data}
    ...
    no use to describe this step in general way. Instead of it we describe this step for our example file, one may easy modify this step for his use case. % !! криво
...
\subsection{Build model}
	...
	\item LDABuilder  \--- builds an LDA (PLSA with Dirichlet regularizer, for details section \ref{Regularizers}) % TODO add a description of a Dirichlet regularizer in the section Regularizers
...
\subsection{Training a model}
    ...
    \subsubsection{How to work with matrices}
